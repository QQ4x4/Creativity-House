    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <h3 className="text-lg font-bold leading-snug text-gray-900 dark:text-white">
          <Link
            href={detailHref}
            className="transition-colors duration-300 hover:text-plum-700 dark:hover:text-gold-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/50"
          >
            {course.title}
          </Link>
        </h3>
