...
export default function LessonActionBar({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-3xl border border-purple-500/20 bg-[#181124]/90 p-4 shadow-xl shadow-black/30 backdrop-blur-md sm:flex-row sm:items-center sm:justify-between">
      <button
        type="button"
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex min-h-[48px] flex-1 items-center justify-center gap-1.5 rounded-xl border border-white/15 px-4 text-sm font-medium text-gray-200 transition-all duration-300 hover:border-white/30 hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/50 disabled:cursor-not-allowed disabled:opacity-40 sm:flex-none"
        >
        ...
        <button
          ...
          onClick={onNext}
          disabled={!hasNext}
          className="inline-flex min-h-[48px] flex-1 items-center justify-center gap-1.5 rounded-xl border border-gold-400/30 bg-gold-400/10 px-4 text-sm font-semibold text-gold-200 transition-all duration-300 hover:border-gold-400/60 hover:bg-gold-400/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/50 disabled:cursor-not-allowed disabled:opacity-40 sm:flex-none"
        >
